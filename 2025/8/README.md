...
<p>To save on string lights, the Elves would like to focus on connecting pairs of junction boxes that are <em>as close together as possible</em> according to straight-line distance. In this example, the two junction boxes which are closest together are <code>162,817,812</code> and <code>425,690,689</code>.</p>
...
<details closed>
<p>The Elves were right; they <em>definitely</em> don't have enough extension cables. You'll need to keep connecting junction boxes together until they're all in <em>one large circuit</em>.</p>
...
<p>Continue connecting the closest unconnected pairs of junction boxes together until they're all in the same circuit. <em>What do you get if you multiply together the X coordinates of the last two junction boxes you need to connect?</em></p>
</details>
